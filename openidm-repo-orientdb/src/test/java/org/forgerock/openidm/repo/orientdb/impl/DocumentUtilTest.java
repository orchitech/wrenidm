...
public class DocumentUtilTest {
    ...
    public void mapToNewFlatDoc() throws ConflictException{
        ...
        assertThat(result.<String>field(DocumentUtil.ORIENTDB_PRIMARY_KEY)).isEqualTo("client-assigned-id")
                .overridingErrorMessage("unexpected ID");
        assertThat(result.<String>field("firstname")).isEqualTo("Sam")
                .overridingErrorMessage("unexpected firstname");
        assertThat(result.<String>field("lastname")).isEqualTo("Iam")
                .overridingErrorMessage("unexpected lastname");
        assertThat(result.<String>field("telephone")).isEqualTo("(555) 123-4567")
                .overridingErrorMessage("unexpected telephone");
        assertThat(result.<Integer>field("age")).isEqualTo(20)
                .overridingErrorMessage("unexpected age");
        assertThat(result.<Long>field("longnumber")).isEqualTo(Long.MAX_VALUE)
                .overridingErrorMessage("unexpected longnumber");
        assertThat(result.<Float>field("amount")).isEqualTo(12345678.89f)
                .overridingErrorMessage("unexpected amount");
        assertThat(result.<Boolean>field("present")).isEqualTo(false)
    ...
    public void mapToNewDocExistingRevision() throws ConflictException {
        ...
        assertThat(result.<String>field(DocumentUtil.ORIENTDB_PRIMARY_KEY))
                .isEqualTo("client-assigned-id")
                .overridingErrorMessage("unexpected ID");
        assertThat(result.<String>field("firstname"))
                .isEqualTo("John")
                .overridingErrorMessage("unexpected firstname");
    ...
    public void mapToNewEmbeddedDoc() throws ConflictException {
        ...
        assertThat(result.<String>field("firstname"))
                .isEqualTo("John")
                .overridingErrorMessage("unexpected firstname");
        assertThat(result.<String>field("lastname"))
                .isEqualTo("Doe")
                .overridingErrorMessage("unexpected lastname");
        assertThat(result.getVersion())
                .isEqualTo(0)
        ...
        assertThat((Object) phonenumbers)
                .isNotNull()
                .overridingErrorMessage("phonenumbers map entry null");
        assertThat(phonenumbers.<String>field("home"))
                .isEqualTo("555-666-7777")
                .overridingErrorMessage("unexpected home phone");
        assertThat(phonenumbers.<String>field("mobile"))
    ...
    public void mapToExistingEmbeddedDoc() throws ConflictException {
        ...
        assertThat((Object) phonenumbers)
                .isNotNull()
                .overridingErrorMessage("phonenumbers map entry null");
        assertThat(phonenumbers.<String>field("work"))
